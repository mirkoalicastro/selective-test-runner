...
public final class Selection {
    ...
    public enum Mode {
        ...
        SELECTED,
        /** Force a full run: cold map, version mismatch, age limit reached, empty intersection,
         *  git failure, or any other safety condition. */
        FULL_RUN
    }
    ...
    private Selection(Mode mode, Set<String> selectedTestIds, Set<String> changedClasses, String reason) {
        this.mode = mode;
    ...
    public static Selection fullRun(String reason, Set<String> changedClasses) {
        return new Selection(Mode.FULL_RUN,
    ...
    public Set<String> selectedTestIds() { return selectedTestIds; }
    public Set<String> changedClasses() { return changedClasses; }
