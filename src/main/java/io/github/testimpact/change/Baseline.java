...
public enum Baseline {
    ...
    public static Baseline parse(String s) {
        ...
        switch (s.trim().toLowerCase()) {
            case "lastcommit":  return LAST_COMMIT;
            case "lasttag":     return LAST_TAG;
            case "lastfullrun": return LAST_FULL_RUN;
            default: throw new IllegalArgumentException("Unknown baseline: " + s);
        }
    }
}
